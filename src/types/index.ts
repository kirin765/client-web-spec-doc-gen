...
// =============================================================================
//
// TODO 개발자 매칭 타입 통합 계획:
// - 실제 구현 단계에서 `src/types/matching.ts`를 생성된 단일 책임 모듈로 유지한다.
// - 이 파일에서는 구현이 시작되는 시점에만 아래 타입을 re-export한다:
//   DeveloperProfile, DeveloperMatchingInput, DeveloperMatchReason, DeveloperMatchResult
// - 현재 단계에서는 기존 앱의 타입 의존 관계를 건드리지 않기 위해 re-export를 보류한다.
